...
//         this.answers = answers;     // string array
...
//     var questionOne = new Question('When was Victor born?',['1991','1992','1993'], 0);
//     var questionTwo = new Question('When was Victor\'s father born?',['1991','1963','1965'], 1);
//     var questionThree = new Question('When was Victor\'s mother born?',['1991','1963','1965'], 2);
    
//     var questionArr = [questionOne, questionTwo, questionThree];
    
//     var n = Math.floor(Math.random() * questionArr.length);
//     questionArr[n].displayQuestion();
//     var enteredAnswer = parseInt(prompt("Please select an answer"));
//     questionArr[n].checkAnswer(enteredAnswer);
...
(function(){
    ...
    function scoreCalc() {
        ...
        do{
            ...
            questionArr[n].displayQuestion();
            var enteredAnswer = parseInt(prompt("Please select an answer"));
            var point = questionArr[n].checkAnswer(enteredAnswer);
            points = points + point;
